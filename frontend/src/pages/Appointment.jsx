...
const Appointment = () => {
  ...
  // creating state variable for date and time for appointment of doctor
  ...
  const getAvailableSlots = async () => {
    ...
    for(let i=0; i<7; i++){
      ...
      //setting end time of the date with with index
  ...
  return docInfo && (
    <div>
        ...
        <div className='sm:ml-72 ms:pl-4 mt-4 font-medium text-gray-700'>
            <p>Booking slots</p>
